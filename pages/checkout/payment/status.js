...
const status = (props) => {
  ...
  const success =
    orderDetails.status === "Completed" && paymentDetails.status === true
      ? "We are happy to let you know that your order was placed successfully and is now being processed. We appreciate you choose asfiya art shop as your shopping partner."
      : "";
  const Failure =
    orderDetails.status === "Pending" ||
    (orderDetails.status === "Sent" && paymentDetails.status === false)
      ? "We regret to notify you that there was a problem with asfiya art shop processing your most recent order. We sincerely regret any trouble this may have brought about. It seems like you payment has been failed due some reason. Please contact on -> 9971790511  for any other details."
      : orderDetails.status === "Completed" && paymentDetails.status === false
      ? "We are delighted to inform you that your order with asfiya art shop has been completed successfully and is on its way to you. Your complete happiness is our first goal, and we are honored to have served you. We regret to inform you that asfiya art shop has trouble processing your most recent payment. We sincerely regret any trouble this may have brought about."
      : orderDetails.status === "Pending" ||
        (orderDetails.status === "Sent" && paymentDetails.status === true)
      ? "Your order is currently being processed and is marked as pending. Please keep in mind that your things will not be dispatched until your payment has been successfully processed. We are delighted to notify you that your payment for the order with asfiya art shop has been processed successfully"
      : "";
